...
- ипользуется при определении класса session, какая-то очень крутая и серьезная весчь, кажется 	нужна чтобы создавать экземпляры класса, через shared_from_this.
